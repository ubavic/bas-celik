...
var documentMedical2 = document.MedicalDocument{
	...
	CarrierGivenNameLatin:  "Arsenije",
	CarrierFamilyNameLatin: "Petrović",
	CarrierGivenName:       "Арсеније",
	CarrierFamilyName:      "Петровић",
	CarrierRelationship:    "Дете",
	CarrierIdNumber:        "19071950123456",
	CarrierInsurantNumber:  "87654321",
	InsurantNumber:         "12345678",
	InsuranceStartDate:     "29.03.2014",
	CardId:                 "12345678901",
	DateOfIssue:            "01.02.2024",
	DateOfExpiry:           "01.02.2029",
	ValidUntil:             "01.02.2039",
	PermanentlyValid:       false,
	CarrierFamilyMember:    true,
	Gender:                 "Мушки",
	InsuranceDescription:   "Самостална занатске делатност",
	InsuranceBasisRZZO:     "123",
	TaxpayerName:           "Arsenije Petrović",
	TaxpayerResidence:      "Beograd",
	TaxpayerIdNumber:       "19071950123456",
}
